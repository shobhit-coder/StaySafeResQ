...
public class CheckFaceSafe  extends AsyncTask<String,String,String>
{
...
//    ArrayList<UserSafe> users;

    CheckFaceSafe(String phone){

        phonenumber=phone;
//        users=new ArrayList<>();
    }

//    public ArrayList<UserSafe> getUsers() {
//
//        if(users.size()==0){
//            Log.v("empty list damnit","empty list damnit");
//        }
//        return users;
//    }
        ...
        else
        {
            try
            {
                ...
                else
                {
                    ...
                    String query = "update location2 set flag=\'y\' where id=\'"+phonenumber+"\';";
                    Log.v("1iamheretomarksafe",phonenumber);
                    Log.v("connesttomarksafe",con.toString());
                    Statement stmt = con.createStatement();
                    stmt.execute(query);
//                    Log.v("checkquery","checkquery"+rs.toString());
//                    while (rs.next())
//                    {
//                        users.add(new UserSafe(rs.getString(1),rs.getString(4),rs.getDouble(2),rs.getDouble(3)));
//                        Log.v("user added to list",new UserSafe(rs.getString(1),rs.getString(4),rs.getDouble(2),rs.getDouble(3)).toString());
////                            str=str+rs.getString(1)+","+rs.getString(2)+","+rs.getString(3)+","+rs.getString(4)+"\n";
//                    }
//                    Log.v("strfromdb",users.toString());
